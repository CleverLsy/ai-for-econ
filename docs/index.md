...
- :material-pipe:{ .lg .middle } **研究 Pipeline**
    ...
    从选题到投稿，每个研究环节的工具流、Skill 调用与人工兜底点。
...
- :material-hammer-wrench:{ .lg .middle } **自己写 Skill**
    ...
    Skill 的结构、最小例子，用一个真实经济学任务走完整套写作流程。
...
- :material-shield-alert:{ .lg .middle } **边界与避坑**
    ...
    学术伦理、数据隐私、AI 幻觉的杀伤力、何时必须人工兜底。

    [:octicons-arrow-right-24: 进入](boundaries/index.md)
...
- **GitHub**：[LiuSongyue/ai-for-econ](https://github.com/LiuSongyue/ai-for-econ) · 欢迎 Issue 与 PR
